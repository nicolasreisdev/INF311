package com.pratica.checkinlocais.data;
...
public final class BancoDados {
    ...
    private final String NOME_BANCO = "locais_bd";
    ...
    // O banco de dados possui uma tabela Checkin e uma tabela de categorias
    // A tabela checkin guarda a quantidade de visitas em um determinado local e a categoria em que ele se encontra
    // A tabela de categorias guarda os nomes das categorias existentes, ela é criada automaticamente pelo banco de dados
    private BancoDados() {
    ...
    private void abrir() {
        ...
        // Abre o banco de dados já existente
            ...
            Log.i("BANCO_DADOS", "Banco já está aberto.");
        }
    }
