...
public final class BancoDados {
    ...
    private final String[] SCRIPT_DATABASE_CREATE = new String[] {
            "CREATE TABLE Location (idLocal INTEGER PRIMARY KEY AUTOINCREMENT,"+
                    "nome TEXT NOT NULL, Lat DOUBLE, Lng DOUBLE);",
            "CREATE TABLE Logs (idLog INTEGER PRIMARY KEY AUTOINCREMENT,"+
                    "msg TEXT NOT NULL, Timestamp TEXT NOT NULL, idLocation INTEGER, FOREIGN KEY (idLocation) REFERENCES Location (idLocal) ON DELETE SET NULL );",
            "INSERT INTO Location (nome, Lat, Lng) VALUES ('MOC', -16.717496756180157, -43.87682393125447);",
            "INSERT INTO Location (nome, Lat, Lng) VALUES ('VICOSA', -20.75824678663597, -42.88029027646495);",
            "INSERT INTO Location (nome, Lat, Lng) VALUES ('DPI', -20.76481707003259, -42.86854663598881);"};
    ...
    public BancoDados() {
        ...
        //Todo banco criado pelo método openOrCreateDatabase() POSSUI UMA TABELA
